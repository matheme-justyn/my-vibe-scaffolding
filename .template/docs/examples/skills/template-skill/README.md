...
cp -r .template/docs/examples/skills/template-skill .agents/skills/your-skill-name

# Or copy to create a new template skill
cp -r .template/docs/examples/skills/template-skill .template/docs/examples/skills/new-skill
```
...
- **SKILL Format Guide:** `.template/docs/SKILL_FORMAT_GUIDE.md`
- **AGENTS.md Guide:** `.template/docs/AGENTS_MD_GUIDE.md`
