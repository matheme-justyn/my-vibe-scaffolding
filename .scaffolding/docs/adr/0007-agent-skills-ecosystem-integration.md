...
詳細分析見：`.scaffolding/docs/RESOURCE_ANALYSIS_AGENT_SKILLS_ECOSYSTEM.md`
...
3. **驗證工具**
   - `.scaffolding/scripts/validate-agents-md.sh` — AGENTS.md linter
...
2. **持續維護需求**
   - 風險：上游標準變更需要追蹤更新
   - 緩解：建立 `.scaffolding/docs/EXTERNAL_RESOURCES.md` 追蹤上游，季度審查
...
**工作項目**：
1. ✅ 建立 ADR 0007（本文件）
2. ☐ 建立 `.scaffolding/docs/AGENTS_MD_GUIDE.md`
3. ☐ 建立 `.scaffolding/docs/SKILL_FORMAT_GUIDE.md`
4. ☐ 建立 `.scaffolding/docs/examples/skills/template-skill/`
...
9. ☐ 建立 `.scaffolding/scripts/consolidate-agent-configs.sh`
...
- `.scaffolding/docs/RESOURCE_ANALYSIS_AGENT_SKILLS_ECOSYSTEM.md` — 完整的 7 資源分析報告
...
- [ADR 0001](./.scaffolding/docs/adr/0001-record-architecture-decisions.md) — ADR 格式規範
- [ADR 0006](./.scaffolding/docs/adr/0006-template-directory-isolation.md) — Template 目錄隔離
