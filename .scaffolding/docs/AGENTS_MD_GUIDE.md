...
- [SKILL.md Format Guide](./.scaffolding/docs/SKILL_FORMAT_GUIDE.md) — Skill 格式詳解
- [ADR 0007](./.scaffolding/docs/adr/0007-agent-skills-ecosystem-integration.md) — Agent skills 整合決策
